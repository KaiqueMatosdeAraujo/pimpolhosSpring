...
public class PedidoController {
	...
	//RETORNA DETALHE DE UM PEDIDO ESPECÍFICO POR CLIENTE
...
//	public ResponseEntity<DetalhePedidoDTO> listarPedido(@PathVariable("id") Integer id ,@PathVariable("idpedido")  Integer idpedido) {
//		Optional<Pedido> pedido = pedidoRepository.findById(idpedido);
//		Optional<Cliente> cliente = clienteRepository.findById(id);
//		List<Pedido>pedidos = new ArrayList<>();
//		pedidos = cliente.get().getPedidos();
...
//	}
	...
	//RETORNA TODOS PEDIDOS DE UM CLIENTE
	@GetMapping("/{idcliente}/meusPedidos")
	public List<DTOPedido> listarMeusPedidos(@PathVariable("idcliente") Integer idcliente){
		List<Pedido> pedido = pedidoRepository.findByClienteCodCliente(idcliente);
		DTOPedido dtoPedido = new DTOPedido();
		return dtoPedido.converter(pedido);
	}
